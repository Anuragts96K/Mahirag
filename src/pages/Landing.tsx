...
export default function Landing() {
  ...
  const longFormVideos = [
    ...
    { src: "https://youtu.be/Lkyu-JnpexIautoplay=1&mute=1&loop=1&playlist=yeilG5tMRk0&controls=0&showinfo=0&rel=0&modestbranding=0&playsinline=1&iv_load_policy=3&disablekb=1&fs=0&cc_load_policy=0", title: "Big Buck Bunny", description: "A large and lovable rabbit deals with three tiny bullies" },
